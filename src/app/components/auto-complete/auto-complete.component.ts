...
export class AutoCompleteComponent implements OnDestroy {
  ...
  private generateShortAddress(properties: any): string {
    ...
    shortAddress += (properties.address.postcode && properties.address.city) ? `, ${properties.address.postcode}-${properties.address.city}` : '';
    shortAddress += (!properties.address.postcode && properties.address.city && properties.address.city !== properties.address.name) ? `, ${properties.address.city}` : '';
    shortAddress += (properties.address.country && properties.address.country !== properties.address.name) ? `, ${properties.address.country}` : '';
 */
    return shortAddress;
  }
