...
export class HeaderComponent implements OnInit {
  ...
  constructor(
    ...
    this.languageIcon.de = _sanitizer.bypassSecurityTrustStyle(
      "url(./assets/icons/de.png)"
    );
    this.languageIcon.en = _sanitizer.bypassSecurityTrustStyle(
      "url(./assets/icons/en.png)"
    );
  }
  ...
  ngOnInit() {
    this._router.events.subscribe((val: any) => {
      if (
        val &&
        val.url &&
        (val.url === "/register" || val.url === "/cockpit")
      ) {
